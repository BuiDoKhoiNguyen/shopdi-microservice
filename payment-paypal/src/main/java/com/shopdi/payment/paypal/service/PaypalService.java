package com.shopdi.payment.paypal.service;
...
import com.shopdi.payment.paypal.model.CheckoutIdHelper;
import com.shopdi.payment.paypal.utils.Constants;
...
public class PaypalService {
    ...
    @Value("${shopdi.public.url}/capture")
    private String returnUrl;
    @Value("${shopdi.public.url}/cancel")
