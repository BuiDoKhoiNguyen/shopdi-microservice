package com.shopdi.cart.repository;

import com.shopdi.cart.model.CartItem;
import com.shopdi.cart.model.CartItemId;
...
public interface CartItemRepository extends JpaRepository<CartItem, CartItemId> {
    /**
     * Retrieves a cart item for a specific customer and product, locking the record
     * to prevent concurrent
     * modifications.
     *
     * @param customerId the ID of the customer whose cart item is being retrieved
     * @param productId  the ID of the product for which the cart item should be
     *                   retrieved
     * @return an {@link Optional} containing the {@link CartItem} entity associated
     *         with the specified customer
     *         and product ID, or an empty {@link Optional} if no matching cart item
     *         is found
     */
    ...
    /**
     * Retrieves a list of cart items for a specific customer, locking the records
     * to prevent concurrent modifications.
     *
     * @param customerId the ID of the customer whose cart items are being retrieved
     * @param productIds the list of product IDs for which the cart items should be
     *                   retrieved
     * @return a list of {@link CartItem} entities associated with the specified
