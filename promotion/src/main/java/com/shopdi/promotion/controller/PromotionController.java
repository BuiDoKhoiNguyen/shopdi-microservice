...
import com.shopdi.promotion.viewmodel.*;
import com.shopdi.promotion.viewmodel.error.ErrorVm;
...
public class PromotionController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Updated", content = @Content(schema = @Schema(implementation = PromotionPutVm.class))),
            @ApiResponse(responseCode = "404", description = "Not found", content = @Content(schema = @Schema(implementation = ErrorVm.class))),
            @ApiResponse(responseCode = "400", description = "Bad request", content = @Content(schema = @Schema(implementation = ErrorVm.class)))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Can't delete promotion", content = @Content(schema = @Schema(implementation = ErrorVm.class)))
    })
