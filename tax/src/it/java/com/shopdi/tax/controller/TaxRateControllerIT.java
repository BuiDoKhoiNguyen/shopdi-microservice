package com.shopdi.tax.controller;
...
import com.shopdi.tax.service.LocationService;
...
class TaxRateControllerIT extends AbstractControllerIT {
    ...
    void test_getPagedTaxRate_shouldReturnData_whenGivenAccessToken() {
        StateOrProvinceAndCountryGetNameVm stateOrProvinceAndCountryGetNameVm = Instancio
                .of(StateOrProvinceAndCountryGetNameVm.class)
                .set(field("stateOrProvinceId"), taxRate.getStateOrProvinceId())
                .create();
