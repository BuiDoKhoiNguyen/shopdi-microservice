package com.shopdi.commonlibrary.mapper;
...
/**
 * A generic base interface for mapping between model, view model, and view
 * model response objects.
 * In case we are implementing create/update operation, we need 3 objects
...
public interface EntityCreateUpdateMapper<M, V, R> {
    ...
    /**
     * Partially updates the provided model entity with values from the given view
     * model.
