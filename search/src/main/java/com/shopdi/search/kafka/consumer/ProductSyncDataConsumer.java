package com.shopdi.search.kafka.consumer;

import static com.shopdi.commonlibrary.kafka.cdc.message.Operation.DELETE;
import static com.shopdi.search.kafka.config.consumer.ProductCdcKafkaListenerConfig.PRODUCT_CDC_LISTENER_CONTAINER_FACTORY;
