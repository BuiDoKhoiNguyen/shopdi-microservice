package com.shopdi.search.kafka;
...
import com.shopdi.search.config.KafkaIntegrationTestConfiguration;
...
public class ProductCdcConsumerTest extends CdcConsumerTest<ProductMsgKey, ProductCdcMessage> {
    ...
    public void test_whenHavingCreateEvent_shouldSyncAsCreate()
        ...
        // Verify ES Sync data
        Optional<com.shopdi.search.model.Product> product = productRepository.findById(productId);
    ...
    public void test_whenHavingUpdateEvent_shouldSyncAsUpdate()
        ...
        com.shopdi.search.model.Product product = getSampleEsProduct(productId);
        ...
        Optional<com.shopdi.search.model.Product> updated = productRepository.findById(productId);
    ...
    private static com.shopdi.search.model.@NotNull Product getSampleEsProduct(long productId) {
        com.shopdi.search.model.Product product = new com.shopdi.search.model.Product();
