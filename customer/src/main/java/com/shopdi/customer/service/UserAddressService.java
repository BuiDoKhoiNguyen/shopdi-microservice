...
import com.shopdi.customer.repository.UserAddressRepository;
import com.shopdi.customer.utils.Constants;
import com.shopdi.customer.viewmodel.address.ActiveAddressVm;
import com.shopdi.customer.viewmodel.address.AddressDetailVm;
import com.shopdi.customer.viewmodel.address.AddressPostVm;
import com.shopdi.customer.viewmodel.address.AddressVm;
import com.shopdi.customer.viewmodel.useraddress.UserAddressVm;
...
public class UserAddressService {
    ...
    public UserAddressVm createAddress(AddressPostVm addressPostVm) {
        ...
        UserAddress userAddress = UserAddress.builder().userId(userId).addressId(addressGetVm.id())
                .isActive(isFirstAddress).build();
