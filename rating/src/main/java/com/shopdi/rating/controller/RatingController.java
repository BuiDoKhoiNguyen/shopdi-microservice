package com.shopdi.rating.controller;
...
import com.shopdi.rating.viewmodel.ResponeStatusVm;
...
public class RatingController {
    ...
    public ResponseEntity<RatingListVm> getRatingListWithFilter(
            ...
            @RequestParam(value = "createdFrom", defaultValue = "1970-01-01T00:00:00.000Z", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) ZonedDateTime createdFrom,
            @RequestParam(value = "createdTo", defaultValue = "#{T(java.time.ZonedDateTime).now().toString()}", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) ZonedDateTime createdTo,
