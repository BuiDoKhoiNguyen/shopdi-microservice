# 🚀 Quick Start Guide - SHOPDI E-commerce Platform
...
- PgAdmin (Database): http://localhost:5050 (admin@shopdi.com/admin)
...
# Build Docker image
cd product && docker build -t shopdi-product:latest .
```
