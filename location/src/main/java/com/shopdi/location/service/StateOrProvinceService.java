...
import com.shopdi.location.mapper.StateOrProvinceMapper;
...
public class StateOrProvinceService {
    ...
    public void updateStateOrProvince(final StateOrProvincePostVm stateOrProvincePostVm,
        ...
        // For the updating case we don't need to check for the state or province being
        // updated
    ...
    public StateOrProvinceListGetVm getPageableStateOrProvinces(int pageNo, int pageSize,
        ...
        final Page<StateOrProvince> stateOrProvincePage = stateOrProvinceRepository
                .getPageableStateOrProvincesByCountry(
                        countryId, pageable);
