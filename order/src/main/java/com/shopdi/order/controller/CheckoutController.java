...
import com.shopdi.order.service.CheckoutService;
import com.shopdi.order.viewmodel.ErrorVm;
...
public class CheckoutController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = ApiConstant.CODE_200, description = ApiConstant.OK, content = @Content()),
