package com.shopdi.recommendation.kafka.config.consumer;

import com.shopdi.commonlibrary.kafka.cdc.config.BaseKafkaListenerConfig;
...
/**
 * Product CDC kafka listener, support convert product cdc message to java
 * object.
 */
@EnableKafka
@Configuration
