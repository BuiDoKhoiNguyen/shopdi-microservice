package com.shopdi.recommendation.vector.common.query;
...
class JdbcVectorService {
    ...
    /*
     * Using JdbcTemplate to keep consistency with Spring AI implementation, instead
     * of using JPA, JdbcClient
     */
