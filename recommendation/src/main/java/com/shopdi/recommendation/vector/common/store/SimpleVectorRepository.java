...
import com.shopdi.recommendation.vector.common.document.DefaultIdGenerator;
...
public abstract class SimpleVectorRepository<D extends BaseDocument, E> implements VectorRepository<D, E> {
     ...
     * {@link com.shopdi.recommendation.vector.common.store.SimpleVectorRepository#getEntity(Long)}
