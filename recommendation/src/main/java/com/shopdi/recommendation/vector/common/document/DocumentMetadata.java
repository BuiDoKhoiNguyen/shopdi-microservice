package com.shopdi.recommendation.vector.common.document;

import com.shopdi.recommendation.vector.common.formatter.DocumentFormatter;
 ...
 * </p>
 * <p>
 * By default, when using {@link org.springframework.ai.document.Document}, the
 * embedding content
 * combines both content and metadata in the following format:
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * This annotation allows configuration of how the document's content will be
 * embedded.
 * For example, to embed only the content, declare
 * <code>embeddingContentFormatter = '{content}'</code>.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <p>
 * Specifies how to format an entity as a query before performing a search.
 * </p>
 * For example, we have Product object we want to build it as 'Dell XPS | 11.22
 * | DELL'
 * , declare <code>queryFormat = '{name} | {price} | {brand}'</code>.
 * </p>
 */
