...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
        ...
        <script>
            ...
            <div class="logoshopdi">
           <img class="logo" src="${url.resourcesPath}/img/shopdilogo.png" alt="shopdi">
        </div>
    <#elseif section = "form">
        ...
        <div>
            <p class="copyright">&copy; copyright - shopdi.nashtech-garage ${.now?string('yyyy')}</p>
        </div>
    </#if>
