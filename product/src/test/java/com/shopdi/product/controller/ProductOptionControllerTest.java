...
import com.shopdi.product.service.ProductOptionService;
import com.shopdi.product.viewmodel.productoption.ProductOptionGetVm;
import com.shopdi.product.viewmodel.productoption.ProductOptionListGetVm;
import com.shopdi.product.viewmodel.productoption.ProductOptionPostVm;
...
class ProductOptionControllerTest {
        ...
        void testUpdateProductOption() throws Exception {
                ...
                when(productOptionService.update(any(ProductOptionPostVm.class), anyLong()))
                                .thenReturn(createProductOption(1L, "Color"));
