...
import com.shopdi.product.ProductApplication;
import com.shopdi.product.model.attribute.ProductTemplate;
import com.shopdi.product.repository.ProductTemplateRepository;
import com.shopdi.product.service.ProductTemplateService;
import com.shopdi.product.viewmodel.productattribute.ProductAttributeVm;
import com.shopdi.product.viewmodel.producttemplate.ProductAttributeTemplateGetVm;
import com.shopdi.product.viewmodel.producttemplate.ProductAttributeTemplatePostVm;
import com.shopdi.product.viewmodel.producttemplate.ProductTemplateGetVm;
import com.shopdi.product.viewmodel.producttemplate.ProductTemplateListGetVm;
import com.shopdi.product.viewmodel.producttemplate.ProductTemplatePostVm;
import com.shopdi.product.viewmodel.producttemplate.ProductTemplateVm;
...
class ProductTemplateControllerTest {
        ...
        void testGetPageableProductTemplates() throws Exception {
                ...
                ProductTemplateListGetVm pageableResponse = new ProductTemplateListGetVm(
        ...
        void testGetProductTemplate() throws Exception {
                ...
                ProductAttributeTemplateGetVm productAttributeTemplateGetVm = new ProductAttributeTemplateGetVm(
                                productAttributeVm, 5);
        ...
        void testGetProductTemplateNotFound() throws Exception {
                when(productTemplateService.getProductTemplate(anyLong()))
        ...
        void testCreateProductTemplate() throws Exception {
                ProductAttributeTemplatePostVm productAttributeTemplate = new ProductAttributeTemplatePostVm(123L, 5);
                ProductAttributeVm productAttributeVm = new ProductAttributeVm(1L, "Color");
                ProductTemplatePostVm postVm = new ProductTemplatePostVm("Laptop Template",
                                List.of(productAttributeTemplate));
                ProductAttributeTemplateGetVm productAttributeTemplateGetVm = new ProductAttributeTemplateGetVm(
                                productAttributeVm, 5);
                ...
                when(productTemplateService.saveProductTemplate(any(ProductTemplatePostVm.class)))
                                .thenReturn(createdVm);
        ...
        void testUpdateProductTemplate() throws Exception {
                ...
                doNothing().when(productTemplateService).updateProductTemplate(anyLong(),
                                any(ProductTemplatePostVm.class));
