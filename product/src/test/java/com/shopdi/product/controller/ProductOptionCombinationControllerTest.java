...
class ProductOptionCombinationControllerTest {
    ...
    void listProductOptionValueOfProduct() throws Exception {
        ...
        ProductOptionCombination mockProductOptionCombination = new ProductOptionCombination();
        ...
        ProductOptionCombination mockProductOptionCombination2 = new ProductOptionCombination();
