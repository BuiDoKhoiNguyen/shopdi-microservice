...
import com.shopdi.product.service.CategoryService;
import com.shopdi.product.viewmodel.ImageVm;
import com.shopdi.product.viewmodel.category.CategoryGetDetailVm;
import com.shopdi.product.viewmodel.category.CategoryGetVm;
import com.shopdi.product.viewmodel.category.CategoryPostVm;
...
class CategoryControllerTest {
        ...
        void testListCategories() throws Exception {
                CategoryGetVm category1 = new CategoryGetVm(2L, "Category 1", "category-1", 1L, new ImageVm(2L, ""));
                CategoryGetVm category2 = new CategoryGetVm(3L, "Category 2", "category-2", 1L, new ImageVm(3L, ""));
