...
import com.shopdi.product.viewmodel.product.ProductOptionValueDisplay;
...
import com.shopdi.product.viewmodel.productoption.ProductOptionValuePostVm;
import com.shopdi.product.viewmodel.productoption.ProductOptionValuePutVm;
...
class ProductControllerIT extends AbstractControllerIT {
    ...
    void initProductPutVm() {
        ...
        productPutVm = new ProductPutVm(
                ...
                new ArrayList<>(List.of(productOptionValuePutVm)), new ArrayList<>(List.of(productOptionValueDisplay)),
                new ArrayList<>(List.of(productOne.getId())), 2L);
    }
