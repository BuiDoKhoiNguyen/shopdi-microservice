...
import com.shopdi.product.viewmodel.productattribute.ProductAttributeValueGetVm;
...
public class ProductDetailService {
        ...
        /**
         * Constructor for {@code ProductRecommendationService} that initializes the
         * service with necessary dependencies.
         *
         * @param productRepository                  the repository responsible for
         *                                           handling product data
         * @param mediaService                       the service responsible for
         *                                           managing media assets associated
         *                                           with products
         * @param productOptionCombinationRepository the repository for managing product
         *                                           option combinations
         */
         ...
         * @return a {@link ProductDetailInfoVm} containing detailed information about
         *         the product
         * @throws NotFoundException if no product is found with the given
         *                           {@code productId}
         */
        ...
        private List<ImageVm> getImagesFromProduct(Product product) {
                return Optional.ofNullable(product.getProductImages())
                                ...
                                .stream()
                                .map(image -> new ImageVm(image.getImageId(),
