...
import com.shopdi.product.repository.ProductAttributeGroupRepository;
import com.shopdi.product.repository.ProductAttributeRepository;
import com.shopdi.product.repository.ProductAttributeTemplateRepository;
...
public class ProductTemplateService {
    ...
    public ProductTemplateVm saveProductTemplate(ProductTemplatePostVm productTemplatePostVm) {
        ...
        List<ProductAttributeTemplate> productAttributeTemplates = setAttributeTemplates(
                productTemplatePostVm.productAttributeTemplates(), productTemplate);
    ...
    public void updateProductTemplate(long productTemplateId, ProductTemplatePostVm productTemplatePostVm) {
        ...
        List<ProductAttributeTemplate> attributeTemplateList = productAttributeTemplateRepository
    ...
    private List<ProductAttributeTemplate> setAttributeTemplates(
        ...
        if (CollectionUtils.isNotEmpty(idAttributes)) {
            List<Long> attributes = productTemplate
                    ...
                    .stream()
                    .map(productAttributeTemplate -> productAttributeTemplate.getProductAttribute().getId()).sorted()
                    .toList();
