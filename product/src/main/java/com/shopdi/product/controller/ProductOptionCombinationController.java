...
import com.shopdi.product.viewmodel.product.ProductOptionCombinationGetVm;
...
public class ProductOptionCombinationController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ProductOptionCombinationGetVm.class))),
