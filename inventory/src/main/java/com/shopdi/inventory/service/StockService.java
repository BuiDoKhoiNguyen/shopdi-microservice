...
import com.shopdi.commonlibrary.exception.StockExistingException;
...
import com.shopdi.inventory.viewmodel.product.ProductQuantityPostVm;
import com.shopdi.inventory.viewmodel.stock.StockPostVm;
import com.shopdi.inventory.viewmodel.stock.StockQuantityUpdateVm;
import com.shopdi.inventory.viewmodel.stock.StockQuantityVm;
import com.shopdi.inventory.viewmodel.stock.StockVm;
...
public class StockService {
    ...
    public List<StockVm> getStocksByWarehouseIdAndProductNameAndSku(Long warehouseId,
            String productName,
            String productSku) {
        HashMap<Long, ProductInfoVm> productInfoVmHashMap = (HashMap<Long, ProductInfoVm>) warehouseService
                .getProductWarehouse(
                        warehouseId,
                        productName,
                        productSku,
    ...
    public void updateProductQuantityInStock(final StockQuantityUpdateVm requestBody) {
        ...
        List<Stock> stocks = stockRepository
                .findAllById(stockQuantityVms.parallelStream().map(StockQuantityVm::stockId).toList());
