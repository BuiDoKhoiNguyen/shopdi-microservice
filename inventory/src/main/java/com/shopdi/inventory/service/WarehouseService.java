...
import com.shopdi.inventory.constants.MessageCode;
import com.shopdi.inventory.model.Warehouse;
import com.shopdi.inventory.model.enumeration.FilterExistInWhSelection;
import com.shopdi.inventory.repository.StockRepository;
import com.shopdi.inventory.repository.WarehouseRepository;
import com.shopdi.inventory.viewmodel.address.AddressDetailVm;
import com.shopdi.inventory.viewmodel.address.AddressPostVm;
import com.shopdi.inventory.viewmodel.address.AddressVm;
import com.shopdi.inventory.viewmodel.product.ProductInfoVm;
import com.shopdi.inventory.viewmodel.warehouse.WarehouseDetailVm;
import com.shopdi.inventory.viewmodel.warehouse.WarehouseGetVm;
import com.shopdi.inventory.viewmodel.warehouse.WarehouseListGetVm;
import com.shopdi.inventory.viewmodel.warehouse.WarehousePostVm;
...
public class WarehouseService {
    ...
    public List<ProductInfoVm> getProductWarehouse(
        ...
        if (!CollectionUtils.isEmpty(productIds)) {
            return productVmList.stream()
                    .map(productVm -> new ProductInfoVm(productVm.id(), productVm.name(), productVm.sku(),
