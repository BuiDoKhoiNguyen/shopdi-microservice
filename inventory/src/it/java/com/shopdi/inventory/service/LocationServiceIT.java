...
import static com.shopdi.inventory.constant.TestConstants.CIRCUIT_BREAKER_NAME;
...
class LocationServiceIT {
    ...
    void test_createAddress_shouldThrowCallNotPermittedException_whenCircuitBreakerIsOpen() {
        AddressPostVm addressPostVm = new AddressPostVm("my contact", "phone number", "address line 1",
                "address line 2", "city", "zip code", 1L,
                1L, 1L);
        circuitBreakerRegistry.circuitBreaker(CIRCUIT_BREAKER_NAME).transitionToOpenState();
