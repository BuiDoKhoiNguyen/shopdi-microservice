...
import static com.shopdi.inventory.util.SecurityContextUtils.setUpSecurityContext;
...
class LocationServiceTest {
    ...
    private static final String INVENTORY_URL = "http://api.shopdi.local/inventory";
