...
class WarehouseControllerTest {
    ...
    void testGetPageableWarehouses_whenValidRequest_thenReturnPagedWarehouses() throws Exception {
        ...
        List<WarehouseGetVm> warehouseContent = List.of(new WarehouseGetVm(1L, "A1"), new WarehouseGetVm(2L, "A2"));
        WarehouseListGetVm warehouseListGetVm = new WarehouseListGetVm(warehouseContent, pageNo, pageSize,
                totalElements, 2, true);
