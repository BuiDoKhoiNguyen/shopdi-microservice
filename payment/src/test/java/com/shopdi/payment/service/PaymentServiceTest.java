...
import com.shopdi.payment.viewmodel.*;
...
class PaymentServiceTest {
    ...
    void initPayment_Success() {
        ...
        InitiatedPayment initiatedPayment = InitiatedPayment.builder().paymentId("123").status("success")
                .redirectUrl("http://abc.com").build();
