package com.shopdi.media.exception;

import com.shopdi.commonlibrary.exception.NotFoundException;
import com.shopdi.commonlibrary.exception.UnsupportedMediaTypeException;
import com.shopdi.media.viewmodel.ErrorVm;
...
public class ControllerAdvisor {
    ...
    private ResponseEntity<ErrorVm> buildErrorResponse(HttpStatus status, String message, List<String> errors,
        ...
        ErrorVm errorVm = new ErrorVm(status.toString(), title.isEmpty() ? status.getReasonPhrase() : title, message,
                errors);
