package com.shopdi.media.controller;
...
import com.shopdi.media.config.FilesystemConfig;
...
import com.shopdi.media.service.MediaService;
...
class MediaControllerIT extends AbstractControllerIT {
    ...
    void test_createMedia_shouldReturn403_ifProvideInvalidAccessToken() throws IOException {
        ...
        given(getRequestSpecification())
                ...
                .multiPart("multipartFile", mediaPostVm.multipartFile().getName(),
